...
public class Gerenciador_Humor{
    private int id_humor;
    ...
    public Gerenciador_Humor() {
    }

    public Gerenciador_Humor(int id_humor, double horas_sono, String ambiente_trabalho, int qtd_agua, int qtd_estresse, String pesquisa_clima, int id_funcionario) {
    ...
    public int getId_humor() {
        return id_humor;
    }

    public void setId_humor(int id_humor) {
        this.id_humor = id_humor;
    }
